...
--
-- Host: mysql.labranet.jamk.fi    Database: L2912_2
-- ------------------------------------------------------
...
CREATE TABLE `Cell` (
  ...
  CONSTRAINT `fk_Cell_CellType1` FOREIGN KEY (`CellTypeId`) REFERENCES `CellType` (`CellTypeId`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `GameSession` VALUES (1,NULL,NULL,NULL);
...
CREATE TABLE `GameSession_has_player` (
  ...
  CONSTRAINT `fk_Player_has_Attendance_Player1` FOREIGN KEY (`PlayerId`) REFERENCES `Player` (`PlayerId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Player_has_Attendance_Attendance1` FOREIGN KEY (`GameSessionId`) REFERENCES `GameSession` (`GameSessionId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_GameSession_has_player_Cell1` FOREIGN KEY (`CellId`) REFERENCES `Cell` (`CellId`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `GameSession_has_player` VALUES (1,1,1),(2,1,1),(3,1,1);
...
CREATE TABLE `Player_has_Building` (
  ...
  CONSTRAINT `fk_Player_has_Building_Player1` FOREIGN KEY (`PlayerId`) REFERENCES `Player` (`PlayerId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Player_has_Building_Building1` FOREIGN KEY (`BuildingId`) REFERENCES `Building` (`BuildingId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Player_has_Building_Attendance1` FOREIGN KEY (`GameSessionId`) REFERENCES `GameSession` (`GameSessionId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Player_has_Cash` (
  ...
  CONSTRAINT `fk_Player_has_Cash_Player1` FOREIGN KEY (`PlayerId`) REFERENCES `Player` (`PlayerId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Player_has_Cash_Cash1` FOREIGN KEY (`CashId`) REFERENCES `Cash` (`CashId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Player_has_Cash_Attendance1` FOREIGN KEY (`GameSessionId`) REFERENCES `GameSession` (`GameSessionId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Player_has_Cash` VALUES (1,1,1),(1,2,1),(2,3,1),(2,4,1),(3,5,1),(3,6,1),(1,31,1),(1,32,1),(1,33,1),(1,34,1),(2,35,1),(2,36,1),(2,37,1),(2,38,1),(3,39,1),(3,40,1),(3,41,1),(3,42,1),(1,61,1),(2,62,1),(3,63,1),(1,91,1),(2,92,1),(3,93,1),(1,101,1),(1,102,1),(2,103,1),(2,104,1),(3,105,1),(3,106,1),(1,121,1),(2,122,1),(3,123,1),(1,141,1),(1,142,1),(1,143,1),(1,144,1),(1,145,1),(2,146,1),(2,147,1),(2,148,1),(2,149,1),(2,150,1),(3,151,1),(3,152,1),(3,153,1),(3,154,1),(3,155,1);
...
CREATE TABLE `Player_has_Cell` (
  ...
  CONSTRAINT `fk_Player_has_Cell_Player1` FOREIGN KEY (`PlayerId`) REFERENCES `Player` (`PlayerId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Player_has_Cell_Cell1` FOREIGN KEY (`CellId`) REFERENCES `Cell` (`CellId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Player_has_Cell_Attendance1` FOREIGN KEY (`GameSessionId`) REFERENCES `GameSession` (`GameSessionId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Player_has_Token` (
  ...
  CONSTRAINT `fk_Player_has_Token_Player1` FOREIGN KEY (`PlayerId`) REFERENCES `Player` (`PlayerId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Player_has_Token_Token1` FOREIGN KEY (`TokenId`) REFERENCES `Token` (`TokenId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Player_has_Token_GameSession1` FOREIGN KEY (`GameSessionId`) REFERENCES `GameSession` (`GameSessionId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-04-10 17:12:57
