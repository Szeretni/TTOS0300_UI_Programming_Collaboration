...
-- -----------------------------------------------------
-- Schema SQL_CSHARP_UI
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema SQL_CSHARP_UI
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `SQL_CSHARP_UI` DEFAULT CHARACTER SET utf8 ;
USE `SQL_CSHARP_UI` ;

-- -----------------------------------------------------
-- Table `SQL_CSHARP_UI`.`Player`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SQL_CSHARP_UI`.`Player` (
...
-- -----------------------------------------------------
-- Table `SQL_CSHARP_UI`.`GameSession`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SQL_CSHARP_UI`.`GameSession` (
...
-- -----------------------------------------------------
-- Table `SQL_CSHARP_UI`.`Cash`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SQL_CSHARP_UI`.`Cash` (
...
-- -----------------------------------------------------
-- Table `SQL_CSHARP_UI`.`CellType`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SQL_CSHARP_UI`.`CellType` (
...
-- -----------------------------------------------------
-- Table `SQL_CSHARP_UI`.`Cell`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SQL_CSHARP_UI`.`Cell` (
  ...
  CONSTRAINT `fk_Cell_CellType1`
    ...
    REFERENCES `SQL_CSHARP_UI`.`CellType` (`CellTypeId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `SQL_CSHARP_UI`.`Building`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SQL_CSHARP_UI`.`Building` (
...
-- -----------------------------------------------------
-- Table `SQL_CSHARP_UI`.`Player_has_Cell`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SQL_CSHARP_UI`.`Player_has_Cell` (
  ...
  CONSTRAINT `fk_Player_has_Cell_Player1`
    ...
    REFERENCES `SQL_CSHARP_UI`.`Player` (`PlayerId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Player_has_Cell_Cell1`
    FOREIGN KEY (`CellId`)
    REFERENCES `SQL_CSHARP_UI`.`Cell` (`CellId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Player_has_Cell_Attendance1`
    FOREIGN KEY (`GameSessionId`)
    REFERENCES `SQL_CSHARP_UI`.`GameSession` (`GameSessionId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `SQL_CSHARP_UI`.`GameSession_has_player`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SQL_CSHARP_UI`.`GameSession_has_player` (
  `PlayerId` INT NOT NULL,
  `GameSessionId` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `SQL_CSHARP_UI`.`Player_has_Cash`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SQL_CSHARP_UI`.`Player_has_Cash` (
  `PlayerId` INT NOT NULL,
  `CashId` INT NOT NULL,
  `GameSessionId` INT NOT NULL,
  ...
  CONSTRAINT `fk_Player_has_Cash_Cash1`
    FOREIGN KEY (`CashId`)
    REFERENCES `SQL_CSHARP_UI`.`Cash` (`CashId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `SQL_CSHARP_UI`.`Player_has_Building`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SQL_CSHARP_UI`.`Player_has_Building` (
  `PlayerId` INT NOT NULL,
  ...
  CONSTRAINT `fk_Player_has_Building_Building1`
    ...
    REFERENCES `SQL_CSHARP_UI`.`Building` (`BuildingId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `SQL_CSHARP_UI`.`Token`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SQL_CSHARP_UI`.`Token` (
...
-- -----------------------------------------------------
-- Table `SQL_CSHARP_UI`.`Player_has_Token`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SQL_CSHARP_UI`.`Player_has_Token` (
  `PlayerId` INT NOT NULL,
  ...
  CONSTRAINT `fk_Player_has_Token_Token1`
    FOREIGN KEY (`TokenId`)
    REFERENCES `SQL_CSHARP_UI`.`Token` (`TokenId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
